...
<div class="flex items-center justify-center mt-6">
  <p class="text-center bb s2 max-w-[800px] mt-2 px-5 font-extrabold">Want to write this essay?<br><span class="text-xs font-light">Hardev Sir's Essay Correction Service. The Cheapest and The Best Essay Correction Service! Guaranteed!</span>
...
{/if}
          ...
          <div class="flex items-center justify-center mt-6">
          <a href="https://ln5.sync.com/dl/8fabe7e20/m9bztvkp-xeanyn2g-2hv3393s-65z89g5r" class="mt-4 text-xs btn4" target="_blank"><b>Download Book as PDF</b></a></div>
