...
import 'intl-tel-input/build/css/intlTelInput.css';
  ...
  let productName = 'cuecardbook';
  let price = 299; // replace with the actual price
  let email = '';
  let password = '';
  let phone = "";
  let firstName = "";
  ...
  try {
    ...
    window.location.href = '/cuecardbook/read';
  }
}
...
<section class="w-full flex justify-center border-black border-[1px] rounded-t-xl overflow-clip max-w-[1420px] mx-7">
  ...
  <!-- svelte-ignore a11y-missing-attribute -->
  <img src="/img/cuecardbook.png" class="w-full max-w-[1420px]">
</section>
...
<!-- Left Info Column -->
    <div class="flex-grow w-3/4 tiny:w-full">  
      ...
      <p class="flex font-extrabold text-2xl justify-center border-black border-b-[1px] px-10 py-7 text-center tiny:border-t-[1px]">Band 9 Cue Card Answers - May-Aug 2023</p>

<div class="flex items-center justify-evenly">
  
  <p class="px-4 py-2 text-base font-semibold text-center"><span class="imgshadowed">💴</span> INR 299</p>
...
<p class="flex justify-center px-6 pb-6">
  Say hello to your new IELTS best friend - the "Band 9 Cue Card Answers - May-Aug 2023". This essential guide is designed just for IELTS aspirants like you, striving to make your preparation journey as smooth as a Sunday drive. <br><br>

Instead of dreading what's around the corner, you'll be riding high on confidence with 81 examiner-chosen cue cards from May to August 2023 tucked under your arm. Imagine the cool comfort of knowing, there are no tricks or surprises waiting for you. <br><br>

And here's where it gets even better. To ensure no stone goes unturned, we've provided a Hindi translation for each sample answer, creating a bridge over any understanding gaps. Now you can tackle the IELTS exam with the assurance that you've left no room unexplored. <br><br>

Aim for the stars with the Band 9 score that's within your grasp. With our stable, reliable, and ultra-user-friendly guide, your dream score isn't just a pipe dream - it's a coming reality!<br><br>

Guard your future against missed opportunities and take the steps towards your aspirations. Propel yourself towards your dreams, starting today. Bag your copy and start your victorious IELTS journey now!<br><br>
</p></div>
...
<!-- Right Info Column -->
    <div class="flex flex-col justify-evenly w-1/4 flex-shrink border-black border-l-[1px] tiny:flex-row tiny:w-full tiny:border-t-black tiny:border-t-[1px]">  
      ...
      <div class="flex flex-col justify-evenly mx-4 my-4 divide-black divide-y-[1px] border-black border-[1px] rounded-md tiny:w-1/2">
        ...
        <p class="px-2 py-2 ml-4 text-xs text-left"><span class="imgshadowed">📃</span> <b>Pages</b> -
          163
        </p>
        <p class="px-2 py-2 ml-4 text-xs text-left"><span class="imgshadowed">💭</span> <b>Cue Cards</b> -
          81
        </p>
