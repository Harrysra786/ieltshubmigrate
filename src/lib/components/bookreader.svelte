<div class="h-screen w-full p-4">
  <div class="h-full flex flex-col">
    <header class="sticky top-0 h-7 flex items-center justify-between z-10">
      <div>A</div>
      <div>b</div>
      <div>c</div>
    </header>
    <main class="flex-grow p-4">
      <div class="text-left">The ultimate productivity hack is saying no.
...
I am reminded of the famous Peter Drucker quote, “There is nothing so useless as doing efficiently that which should not be done at all.”</div>
    </main>
    <footer class="sticky bottom-0 h-7 flex items-center justify-between">
      <div>x</div>
      <div>y</div>
      <div>z</div>
    </footer>
