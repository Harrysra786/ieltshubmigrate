...
function autoResize(element) {
  ...
  async function handleSubmit() {
    ...
    const response = await fetch('https://connect.pabbly.com/workflow/sendwebhookdata/IjU3NjUwNTZkMDYzMzA0MzE1MjZmNTUzMDUxMzIi_pc', {
      method: 'POST',
      headers: {
    ...
    // Add this line to show the confirmation alert
    alert("Writing Task Submitted Successfully!");
  }
</script>
