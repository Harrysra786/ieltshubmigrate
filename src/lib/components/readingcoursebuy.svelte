...
let productName = 'Reading Course';
let price = 2999; // replace with the actual price
...
<section class="w-full flex justify-center border-black border-[1px] rounded-t-xl overflow-clip max-w-[1420px] mx-7">
  ...
  <img src="/img/readingcoursecover3.png" class="w-full max-w-[1420px]">
</section>
...
<!-- Left Info Column -->
    <div class="w-3/4 tiny:w-full flex-grow">  


      <p class="flex font-extrabold text-2xl justify-center border-black border-b-[1px] px-10 py-7 text-center tiny:border-t-[1px]">The Complete IELTS Reading Improvement Mastercourse</p>

<div class="flex justify-evenly items-center">
  
  <p class="text-base font-semibold text-center px-4 py-2">🪙 INR 2999</p>
  <div class="border-l-[1px] border-black h-20"></div>
  <!-- svelte-ignore a11y-missing-attribute -->
  <p class="text-base font-semibold text-center px-4 py-2"><img src="/img/Hardev Sir Avatar.png" class="avatar online w-6 rounded-full "> Hardev Singh</p>
  <div class="border-l-[1px] border-black h-20"></div>
  <p class="text-base font-semibold text-center px-4 py-2">⭐⭐⭐⭐⭐ 211 Ratings</p>
  ...
  <div>
    <div class="flex flex-col items-center justify-center border-black border-t-[1px] pt-6">
      <!-- Book picture -->
      <PaymentButton {productName} {price} on:paymentSuccess={handlePaymentSuccess} /></div>
<p class="flex justify-center pb-6 px-6">
  Unlock your potential with 'The Complete IELTS Reading Improvement Mastercourse'. This all-inclusive course offers effective tips and strategies to conquer the IELTS Reading section.
  <br><br>
  Designed by an IELTS expert with over 10 years of training experience, it provides a step-by-step guide to tackle every type of question, enhancing your reading speed, comprehension, and analytical skills. Whether you're a beginner or an advanced learner, this course will elevate your score to new heights. 
  <br><br>
  Don't just aim to pass the IELTS, aim to excel with 'The Complete IELTS Reading Improvement Mastercourse'. Your path to IELTS success is just a course away. Enroll now and transform your reading skills forever.
</p></div>
...
<!-- Right Info Column -->
    <div class="flex flex-col justify-evenly w-1/4 flex-shrink border-black border-l-[1px] tiny:flex-row tiny:w-full tiny:border-t-black tiny:border-t-[1px]">  
      ...
      <div class="flex flex-col justify-evenly mx-4 my-4 divide-black divide-y-[1px] border-black border-[1px] rounded-md tiny:w-1/2">
        ...
        <p class="px-2 py-2 text-xs text-left">📁 Format -

          Digital
        </p>

        <p class="px-2 py-2 text-xs text-left">📃 Videos: 15
        </p>

        <p class="px-2 py-2 text-xs text-left">🌍Language: Hindi
        </p>
      ...
      <header>
        <h3 class="text-center text-xl font-bold font-sans">Ratings</h3>
        <div class="rating-rate">
          <span class="icon-rate icon-solid-star-rate">★</span>
          <div class="rating-average-rate">5.0</div>(211 ratings)
        </div>
      </header>
