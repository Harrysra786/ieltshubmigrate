<script>
  ...
  onMount(() => {
	...
	// Subscribe to the essayTopic store
...
<section class="flex items-center justify-center bg-white">
	<div class="max-w-[840px]">
		...
		<div>
			<div class="flex flex-col items-center justify-center pb-10 mx-2 mt-10 border border-neutral-800">
				...
				>
					...
					>
						...
						/></div></div>
			<TextArea
				on:textChange={(e) => (intro = e.detail)}
				id="intro"
				placeholder="Speak or type your introduction here."
				title="Introduction"
			/>
			<TextArea
				on:textChange={(e) => (mbp1 = e.detail)}
				id="mbp1"
			...
			/>
			<TextArea
				on:textChange={(e) => (conclusion = e.detail)}
				id="conclusion"
